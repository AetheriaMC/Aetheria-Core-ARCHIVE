...
public class CommandListener implements Listener {
	...
	public void onChat2(ChatEvent e) {
		...
		if (e.getMessage().startsWith("/")) for (ProxiedPlayer staff : getInstance().getPlayers())
			if (inCSpy.contains(staff.getUniqueId())) if (Hush.contains(staff.getUniqueId())) break;
			else
