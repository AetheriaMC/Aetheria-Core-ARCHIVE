...
public class PunishGUI {
    ...
    public void PunishGUI(Player sender, OfflinePlayer target){
        ...
        ItemStack Border = new ItemStackBuilder(XMaterial.BLACK_STAINED_GLASS_PANE.parseMaterial()).amount(1).name(ChatColor.BLUE + "").build();
        //Create Inventory
        //TODO look into 27 size
        gui = GuiUtils.halfGuiWithBorder("Punish " + target.getName(), Border, true);
        //Create Meta
